...
class ComicBookSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($comic_books as $comic_book) {
            ...
            $new_comic_book->title = $comic_book['title'];
            $new_comic_book->description = $comic_book['description'];
            $new_comic_book->thumb = $comic_book['thumb'];
            $new_comic_book->price = $comic_book['price'];
            $new_comic_book->series = $comic_book['series'];
            $new_comic_book->sale_date = $comic_book['sale_date'];
            $new_comic_book->type = $comic_book['type'];
